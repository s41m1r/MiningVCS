...
public class History {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 */
			repository = FSRepositoryFactory.create(
					FSRepositoryFactory.createLocalRepository(
							new File("/home/saimir/svn/ParaFulMINER"), true, false));
		 ...
		 */
		ISVNAuthenticationManager authManager = SVNWCUtil.createDefaultAuthenticationManager(new File("/home/saimir/svn/ParaFulMINER"), name, password.toCharArray());
